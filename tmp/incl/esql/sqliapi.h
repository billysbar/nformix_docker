 ...
 * Copyright IBM Corporation 1997, 2009. All rights reserved.
 *
 *  Title:       sqliapi.h
...
MI_EXT_DECL	void sqli_connect_open(int4 version, mint conn_kw, const char *dbenv, const char *conn_name, ifx_conn_t *conn_spec, mint concur_tx);
...
MI_EXT_DECL	void sqli_mt_connect(int4 version, mint conn_kw, char *dbenv, char *conn_name, void *conn_hdl, mint concur_tx);
...
MI_EXT_DECL	void sqli_connect_open_tcb(int4 version, mint conn_kw, const char *dbenv, const char *conn_name, ifx_conn_t *conn_spec, mint concur_tx, void *alltcbp);
...
#define SQLI_exec_proc_2(curs, cmd, icnt, ibind, ocnt, obind, sysdesc, chkind, freecurs) \
	sqli_proc_exec_2(ESQLINTVERSION, curs, cmd, icnt, ibind, ocnt, obind, sysdesc, chkind, freecurs)
